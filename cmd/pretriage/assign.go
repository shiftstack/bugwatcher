...
func assign(jiraClient *jira.Client, issue jira.Issue, assigneeAccountID string) error {
	res, err := jiraClient.Issue.UpdateAssignee(issue.ID, &jira.User{AccountID: assigneeAccountID})
	if err != nil && res == nil {
