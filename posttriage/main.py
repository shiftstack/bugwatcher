...
SHIFTSTACK_QUERY = (
    ...
    "&bug_status=POST&bug_status=MODIFIED&bug_status=ON_DEV&bug_status=ON_QA&bu"
    "g_status=VERIFIED&f1=component&f10=component&f11=component&f12=component&f"
    "13=CP&f15=CP&f17=CP&f18=keywords&f2=OP&f3=rh_sub_components&f4=rh_sub_comp"
    "onents&f5=rh_sub_components&f6=rh_sub_components&f7=OP&f8=short_desc&f9=OP"
    "&j2=OR&j9=OR&list_id=12283070&o1=notequals&o10=equals&o11=equals&o12=equal"
    "s&o18=substring&o3=equals&o4=equals&o5=equals&o6=equals&o8=anywords&order="
    "Bug%20Number&query_format=advanced&v1=Documentation&v10=Installer&v11=Mach"
    "ine%20Config%20Operator&v12=Cloud%20Compute&v18=Triaged&v3=OpenShift%20on%"
    "20OpenStack&v4=OpenStack%20CSI%20Drivers&v5=OpenStack%20Provider&v6=platfo"
    "rm-openstack&v8=osp%20openstack"
)
...
def check_bugs():
    ...
    query["limit"] = 1000
    query["offset"] = 0
    query["include_fields"] = ["id", "keywords", "severity", "priority", "target_release", "flags"]
